...
const mockRecipes = [
    {
        ...
        instructions:
            "Cook quinoa according to package instructions. Combine all ingredients in a bowl. Drizzle with olive oil and lemon juice. Season with salt and pepper. Garnish with fresh herbs.",
        dietaryInfo: {
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
        ...
        suitableFor: ["Healthy", "Underweight", "Heart Disease", "Diabetes"],
    },
    {
        id: 2,
        ...
        instructions:
            "Season salmon with salt and pepper. Grill for 4-5 minutes per side. Mix avocado, red onion, tomato, lime juice, and cilantro. Serve salmon topped with avocado salsa.",
        dietaryInfo: {
            isVegetarian: false,
            isVegan: false,
            isGlutenFree: true,
    ...
    },
    {
        ...
        instructions:
            "Blend banana, berries, protein powder, yogurt, and almond milk until smooth. Pour into a bowl. Top with granola, fresh fruit, and nuts.",
        dietaryInfo: {
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
        ...
        suitableFor: ["Healthy", "Underweight", "Active"],
    },
    {
        id: 4,
        ...
        instructions:
            "Sauté garlic in sesame oil. Add carrots and peas, cook until tender. Push vegetables to the side, scramble eggs. Add cauliflower rice and soy sauce. Mix everything together and cook for 5-7 minutes. Garnish with green onions.",
        dietaryInfo: {
            isVegetarian: true,
            isVegan: false,
            isGlutenFree: true,
        ...
        suitableFor: ["Obese", "Diabetes", "Heart Disease"],
    },
    {
        id: 5,
        ...
        fat: 4,
        prepTime: 40,
        tags: ["High Fiber", "Low Fat", "Plant-Based"],
        ingredients: [
            "1 cup dried lentils",
            "1 onion, diced",
            "2 carrots, diced",
        ...
        instructions:
            "Sauté onion, carrots, celery, and garlic. Add lentils, tomatoes, broth, and spices. Bring to a boil, then simmer for 30 minutes until lentils are tender. Garnish with fresh herbs.",
        dietaryInfo: {
            isVegetarian: true,
            isVegan: true,
            isGlutenFree: true,
        ...
        suitableFor: ["Healthy", "Obese", "Heart Disease", "Diabetes"],
    },
]
                            ...
                            <div className="space-y-4">
                                {filteredRecipes.length === 0 ? (
                                    ...
                                    filteredRecipes.map((recipe) => (
                                        <Card key={recipe.id} className="glassmorphic overflow-hidden">
                                            <div className="flex flex-col md:flex-row">
                                                ...
                                                <div className="w-full md:w-2/3 p-4">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        >
                                                            {activeRecipe === recipe.id ? "Hide Details" : "View Recipe"}
                                                        </Button>
                                                        <Button
                                                            size="sm"
                                                            variant="outline"
                            ...
                            {savedRecipes.length === 0 ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {mockRecipes
                                        ...
                                        .map((recipe) => (
                                            <Card key={recipe.id} className="overflow-hidden border-white/10">
