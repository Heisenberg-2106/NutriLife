      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="glassmorphic">
          ...
          <CardContent>
            ...
            <div className="mt-4">
              <Button asChild size="sm" className="w-full bg-neon-blue/80 hover:bg-neon-blue animate-glow">
                <Link href="/nutrition">
        ...
        <Card className="glassmorphic">
          ...
          <CardContent>
            ...
            <div className="mt-4">
              <Button asChild size="sm" className="w-full bg-neon-purple/80 hover:bg-neon-purple animate-glow">
                <Link href="/hydration">
                  <Plus className="mr-2 h-4 w-4" />
                  Add Water
                </Link>
        ...
        <Card className="glassmorphic">
          ...
          <CardContent>
            ...
            <div className="mt-4">
              <Button asChild size="sm" className="w-full bg-neon-green/80 hover:bg-neon-green animate-glow">
                <Link href="/activity">
                  <Plus className="mr-2 h-4 w-4" />
                  Log Activity
                </Link>
